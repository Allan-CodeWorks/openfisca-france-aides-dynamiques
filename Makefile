...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_france-aides-dynamiques openfisca_france-aides-dynamiques/tests

serve-local: build
	openfisca serve --country-package openfisca_france-aides-dynamiques
