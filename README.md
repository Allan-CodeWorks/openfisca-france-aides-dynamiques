# OpenFisca France-Aides-Dynamiques
...
These elements are described in different folders. All the modelling happens within the `openfisca_france-aides-dynamiques` folder.
...
```sh
pip install openfisca_france-aides-dynamiques
```
...
```sh
git clone https://github.com/openfisca/openfisca-france-aides-dynamiques.git
cd openfisca-france-aides-dynamiques
...
Substitute your package's country name for `openfisca_france-aides-dynamiques` below:

```sh
curl -X POST -H "Content-Type: application/json" \
  -d @./openfisca_france-aides-dynamiques/situation_examples/couple.json \
